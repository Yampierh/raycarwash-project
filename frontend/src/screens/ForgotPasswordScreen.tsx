            ...
            {sent ? (
              <View style={styles.successContainer}>
                ...
                <Text style={styles.subtitle}>
                  If an account with{" "}
                  <Text style={styles.emailHighlight}>{email}</Text> exists, we sent a reset link. Check your inbox and spam folder.
                </Text>
                <Button
                  title="BACK TO LOGIN"
...
const styles = StyleSheet.create({
  ...
  subtitle: { color: "#64748B", fontSize: 14, lineHeight: 22, marginBottom: 32 },
  emailHighlight: { color: "#CBD5E1", fontWeight: "600" },
  fieldGroup: { marginBottom: 20 },
  errorText: { color: "#EF4444", fontSize: 11, marginTop: 5, marginLeft: 4 },
  successContainer: { flex: 1, alignItems: "center", paddingTop: 40, gap: 12 },
  successIcon: {
    width: 80,
    height: 80,
    borderRadius: 40,
