    ...
    return (
      ...
      >
        <View style={styles.cardContent}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.vTitle}>{item.make} {item.model}</Text>
            <View style={styles.plateBadge}>
              <Text style={styles.vPlate}>{item.license_plate}</Text>
            </View>
          </View>
          <View style={[styles.radio, isSelected && styles.radioActive]}>
            {isSelected && <Ionicons name="checkmark-sharp" size={16} color="#0B0F1A" />}
          </View>
        </View>
      </TouchableOpacity>
    );
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={{ flex: 1, paddingHorizontal: 20 }}>
        <View style={styles.introBox}>
          ...
          <Text style={styles.subtitle}>Which cars are we detailing today?</Text>
        </View>
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <EmptyState
                ...
                subtitle="Tap + above to add your first vehicle"
                dashed={false}
                style={{ marginTop: 20 }}
              />
            }
...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: "white", fontSize: 18, fontWeight: "800", textAlign: "center" },
  headerStep: { color: Colors.primary, fontSize: 11, fontWeight: "600", textAlign: "center" },
  introBox: { marginVertical: 24 },
  title: { color: "white", fontSize: 28, fontWeight: "900" },
  subtitle: { color: "#64748B", fontSize: 15, marginTop: 5, fontWeight: "500" },
  card: {
    backgroundColor: "#161E2E", padding: 20, borderRadius: 20,
    marginBottom: 14, borderWidth: 1.5, borderColor: "#262F3F",
  },
  cardSelected: { borderColor: Colors.primary, backgroundColor: "#1A2436" },
  cardContent: { flexDirection: "row", alignItems: "center", gap: 18 },
  iconContainer: {
    width: 52, height: 52, borderRadius: 16, backgroundColor: "#0B0F1A",
    justifyContent: "center", alignItems: "center",
  },
  iconActive: { backgroundColor: Colors.primary },
  vTitle: { color: "white", fontWeight: "800", fontSize: 18, marginBottom: 4 },
  plateBadge: {
    backgroundColor: "#262F3F", alignSelf: "flex-start",
    paddingHorizontal: 10, paddingVertical: 4, borderRadius: 6,
  },
  vPlate: { color: "#94A3B8", fontSize: 12, fontWeight: "700", letterSpacing: 1 },
  radio: {
