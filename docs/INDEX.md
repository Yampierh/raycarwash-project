...
| **`23-auth-hardening.md`** | :construction: **Fase 1 complete (days 1-3): Session ORM + repo + Redis cache + `sid` claim + login/refresh integration + enforce flag (default OFF)** | **Critical** | None | — (absorbe `10-authorization-layer.md`) |
