...
| **`24-auth-pages-and-admin-dashboard.md`** | :construction: **Wave 1 done · W2-A shipped** (Wave 1: 8 items; Wave 2 first slice `GET /admin/ops/dashboard` landed; P-4/P-5/S-2/C-2 deferred to Waves 3-4) | High | `22`, `23`, `m_019` | `19`, `20`, `21` |
